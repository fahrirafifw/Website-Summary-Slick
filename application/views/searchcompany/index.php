            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-center mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Search Slik Company</h1>
                    </div>
                    ...
                    <div class="card shadow card col-md-6 text-center mx-auto">
                        <center>
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary"> Search Slik Company</h6>
                            </div>
                        </center>
                        ...
                        <select name="jenisidcard" id="KTP" form="jenisidcard">
                                        ...
                                        <span class = "text-danger"><?php echo $this->session->flashdata('alanper_error'); ?></span>
