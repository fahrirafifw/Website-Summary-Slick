...
<head>
    ...
    <title>Summary Slik - Login</title>
    ...
    <link href="<?= base_url();?>/vendor/sbadmin2/css/sb-admin-2.css" rel="stylesheet">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Summary Slik!</h1>
                                    </div>
                                    ...
                                    <form class="user" method="post" action="<?php echo base_url('auth/login') ?>">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                ...
                                                placeholder="Enter Username..." value="<?= set_value('name'); ?>">
